...
internal class DataSourceBuilder(env: Map<String, String>) {
    ...
    private val databaseUsername: String = requireNotNull(env["DATABASE_SPOOGLE_OPPRYDDING_DEV_USERNAME"]) { "DATABASE_SPOOGLE_OPPRYDDING_USERNAME must be set" }
    private val databasePassword: String = requireNotNull(env["DATABASE_SPOOGLE_OPPRYDDING_DEV_PASSWORD"]) { "DATABASE_SPOOGLE_OPPRYDDING_PASSWORD must be set" }
    private val databaseName: String = requireNotNull(env["DATABASE_SPOOGLE_OPPRYDDING_DEV_DATABASE"]) { "DATABASE_SPOOGLE_OPPRYDDING_DEV_DATABASE must be set" }
