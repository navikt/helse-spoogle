...
private val flywayVersion = "12.0.1"
...
private val ktorVersion = "3.4.0"
private val logbackSyslog4jVersion = "1.0.0"

plugins {
    kotlin("jvm") apply true
    id("org.jetbrains.kotlin.plugin.serialization") version "2.3.10" apply true
}
...
dependencies {
    ...
    implementation("no.nav.security:token-validation-ktor-v3:6.0.2")
